...
async function generateCacheKey(inputPath, operations) {
    try {
        // Read file content to create content-based hash
...
async function processImageWithSharp(config, options) {
    ...
    // Generate cache key based on file content + operations
    ...
    // Simple file existence check like the old version
    try {
        ...
        // Output file doesn't exist, continue with processing
    }
